---
description: Troubleshoot overlapping OSD and double FPS counters caused by RivaTuner Statistics Server (RTSS) injecting into Blish HUD.
id: rtss-osd-overlapping
